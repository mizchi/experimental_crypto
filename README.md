...
| Passwordless auth | `webauthn` | WebAuthn / FIDO2 verification — assertion + attestation (packed/fido-u2f/none), authenticatorData/COSE_Key parsing, clientDataJSON binding; composes cose_cbor + p256/p384/ed25519 + pkix_verify. Verified against Yubico fido2 vectors. |
