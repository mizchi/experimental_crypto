...
| Transport | `tls13` | TLS 1.3 (RFC 8446) key schedule (HKDF-Expand-Label / Derive-Secret + traffic-secret chain) and record layer (AEAD framing + per-record nonce); handshake state machine WIP. |
