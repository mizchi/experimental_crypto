...
| Transport | `tls13` | TLS 1.3 (RFC 8446) key schedule, record layer (AEAD framing + per-record nonce), and handshake framing + Finished/CertificateVerify authentication; message-body codecs and the client state machine WIP. |
